...
text_xs =
    basefont * 0.75 |> round |> Font.size


text_sm =
    basefont * 0.875 |> round |> Font.size


text_base =
    basefont |> round |> Font.size


text_lg =
    basefont * 1.125 |> round |> Font.size


text_xl =
    basefont * 1.25 |> round |> Font.size


text_2xl =
    basefont * 1.5 |> round |> Font.size


text_3xl =
    basefont * 1.875 |> round |> Font.size


text_4xl =
    basefont * 2.25 |> round |> Font.size


text_5xl =
    basefont * 3 |> round |> Font.size


text_6xl =
    basefont * 3.75 |> round |> Font.size


text_7xl =
    basefont * 4.5 |> round |> Font.size


text_8xl =
    basefont * 6 |> round |> Font.size


text_9xl =
    basefont * 8 |> round |> Font.size
